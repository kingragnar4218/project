<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Breaking_page.aspx.cs" Inherits="newspaperproject.Breaking_page" %>
      ...
      <span class="ml-3 text-xl">News Pepar Web Applicatin</span>
       ...
       <nav class="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400	flex flex-wrap items-center text-base justify-center">
           ...
           <asp:Button class="mr-5 hover:text-gray-900" ID="Button7" runat="server" Text="Business News" OnClick="Button7_Click" />
            <asp:Button class="mr-5 hover:text-gray-900" ID="Button8" runat="server" Text="contact as"  />
    </nav>
   <%-- <nav class="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400	flex flex-wrap items-center text-base justify-center">
...
<h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl text-center "><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Breaking News </span> </h1>
